...
//        Member creator = customerRepository.findByUsername(username)
...
//        currPost.setKmlFile(KMLFileMapper.mapToKML(postDto.getKmlFile()));
...
//            posts.setComments(postRepository.findById(posts.getPostId()).orElseThrow(
